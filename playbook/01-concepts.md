...
3. Watch a skill run cold at 09:38: [`foodora-smoke`](../.github/skills/foodora-smoke/SKILL.md), in
   a fresh chat, with only `run foodora-smoke`. It ships with the repository, so you can run it
   yourself — at the break, or at home: a new chat, **Agent**, and `run foodora-smoke`.
