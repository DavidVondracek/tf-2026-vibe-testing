...
| [`foodora-smoke`](../.github/skills/foodora-smoke/SKILL.md) | The 09:38 live demo, run cold: three checks with spec IDs, a fixed report table, FAIL when a step cannot run |
